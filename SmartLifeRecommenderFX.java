...
public class SmartLifeRecommenderFX extends Application {
    ...
    private Button createSidebarButton(String icon, String text) {
        ...
        // Text label - FIXED COLOR FOR BETTER VISIBILITY
        Label textLabel = new Label(text);
        textLabel.setFont(Font.font("Segoe UI", FontWeight.BOLD, 14));
        textLabel.setTextFill(Color.WHITE); // Changed to white for better contrast
        
        buttonContent.getChildren().addAll(iconLabel, textLabel);
        button.setGraphic(buttonContent);
        
        // Enhanced button styling with darker background
        LinearGradient buttonGradient = new LinearGradient(
            0, 0, 1, 0, true, CycleMethod.NO_CYCLE,
            new Stop(0, Color.rgb(15, 15, 25, 0.9)),
            new Stop(1, Color.rgb(25, 25, 35, 0.9))
        );
        BackgroundFill buttonFill = new BackgroundFill(buttonGradient, new CornerRadii(10), null);
        ...
        button.setOnAction(e -> {
            ...
            // Auto-hide sidebar after selection (optional)
            toggleSidebar();
        });
    ...
    private void seedData() {
        ...
        action.add(new Recommendation("John Wick", "images/movies/action/john_wick.jpg", "https://www.imdb.com/title/tt2911666/"));
        action.add(new Recommendation("The Legend of Maula Jatt", "images/movies/action/maula_jatt.jpg", "https://www.imdb.com/title/tt4139928/"));
        action.add(new Recommendation("The Fall Guy", "images/movies/action/fall_guy.jpg", "https://www.imdb.com/title/tt1684562/"));
        action.add(new Recommendation("Mission: Impossible", "images/movies/action/mission_impossible.jpg", "https://www.imdb.com/title/tt9603212/"));
        action.add(new Recommendation("Extraction II", "images/movies/action/extraction_2.jpg", "https://www.imdb.com/title/tt12263384/"));
        action.add(new Recommendation("John Wick: Chapter 4", "images/movies/action/john_wick_4.jpg", "https://www.imdb.com/title/tt10366206/"));
        action.add(new Recommendation("Godzilla Vs Kong", "images/movies/action/godzilla_vs_kong.jpg", "https://www.imdb.com/title/tt5034838/"));
        action.add(new Recommendation("Fast X", "images/movies/action/fast_x.jpg", "https://www.imdb.com/title/tt5433140/"));
        movieData.put("Action", action);

        // Comedy Movies
        List<Recommendation> comedy = new ArrayList<>();
        comedy.add(new Recommendation("Housefull 5", "images/movies/comedy/housefull_5.jpg", "https://www.imdb.com/title/tt9104736/"));
        comedy.add(new Recommendation("Jumanji", "images/movies/comedy/jumanji.jpg", "https://www.imdb.com/title/tt2283362/"));
        comedy.add(new Recommendation("The Hangover", "images/movies/comedy/the_hangover.jpg", "https://www.imdb.com/title/tt1119646/"));
        comedy.add(new Recommendation("3 Idiots", "images/movies/comedy/3_idiots.jpg", "https://www.imdb.com/title/tt1187043/"));
        comedy.add(new Recommendation("Deadpool", "images/movies/comedy/deadpool.jpg", "https://www.imdb.com/title/tt1431045/"));
        comedy.add(new Recommendation("crew", "images/movies/comedy/crew.jpg", "https://www.imdb.com/title/tt21383812/"));
        comedy.add(new Recommendation("Na Baligh Afraad", "images/movies/comedy/Na Baligh Afraad.jpg", "https://www.imdb.com/title/tt32552818/"));
        comedy.add(new Recommendation("Ant-Man", "images/movies/comedy/ant_man.jpg", "https://www.imdb.com/title/tt0478970/"));
        movieData.put("Comedy", comedy);

        // Sci-Fi Movies
        List<Recommendation> scifi = new ArrayList<>();
        scifi.add(new Recommendation("Interstellar", "images/movies/scifi/interstellar.jpg", "https://www.imdb.com/title/tt0816692/"));
        scifi.add(new Recommendation("Inception", "images/movies/scifi/inception.jpg", "https://www.imdb.com/title/tt1375666/"));
        scifi.add(new Recommendation("Blade Runner 2049", "images/movies/scifi/blade_runner_2049.jpg", "https://www.imdb.com/title/tt1856101/"));
        scifi.add(new Recommendation("The Matrix", "images/movies/scifi/matrix.jpg", "https://www.imdb.com/title/tt0133093/"));
        scifi.add(new Recommendation("Dune", "images/movies/scifi/dune.jpg", "https://www.imdb.com/title/tt1160419/"));
        scifi.add(new Recommendation("Arrival", "images/movies/scifi/arrival.jpg", "https://www.imdb.com/title/tt2543164/"));
        scifi.add(new Recommendation("Ex Machina", "images/movies/scifi/ex_machina.jpg", "https://www.imdb.com/title/tt0470752/"));
        scifi.add(new Recommendation("Gravity", "images/movies/scifi/gravity.jpg", "https://www.imdb.com/title/tt1454468/"));
        movieData.put("Sci-Fi", scifi);     

        // Romance Movies
        List<Recommendation> romance = new ArrayList<>();
        romance.add(new Recommendation("The Notebook", "images/movies/romance/notebook.jpg", "https://www.imdb.com/title/tt0332280/"));
        romance.add(new Recommendation("La La Land", "images/movies/romance/la_la_land.jpg", "https://www.imdb.com/title/tt3783958/"));
        romance.add(new Recommendation("Titanic", "images/movies/romance/titanic.jpg", "https://www.imdb.com/title/tt0120338/"));
        romance.add(new Recommendation("The Fault in Our Stars", "images/movies/romance/fault_in_stars.jpg", "https://www.imdb.com/title/tt2582846/"));
        romance.add(new Recommendation("Me Before You", "images/movies/romance/me_before_you.jpg", "https://www.imdb.com/title/tt2674426/"));
        romance.add(new Recommendation("A Star is Born", "images/movies/romance/star_is_born.jpg", "https://www.imdb.com/title/tt1517451/"));
        romance.add(new Recommendation("Pride and Prejudice", "images/movies/romance/pride_prejudice.jpg", "https://www.imdb.com/title/tt0414387/"));
        romance.add(new Recommendation("Casablanca", "images/movies/romance/casablanca.jpg", "https://www.imdb.com/title/tt0120338/"));
        ...
        shonen.add(new Recommendation("Attack on Titan", "images/anime/shonen/aot.jpg", "https://myanimelist.net/anime/16498/Shingeki_no_Kyojin"));
        shonen.add(new Recommendation("Demon Slayer", "images/anime/shonen/demon_slayer.jpg", "https://myanimelist.net/anime/38000/Kimetsu_no_Yaiba"));
        shonen.add(new Recommendation("My Hero Academia", "images/anime/shonen/mha.jpg", "https://myanimelist.net/anime/31964/Boku_no_Hero_Academia"));
        shonen.add(new Recommendation("Naruto", "images/anime/shonen/naruto.jpg", "https://myanimelist.net/anime/20/Naruto"));
        shonen.add(new Recommendation("One Piece", "images/anime/shonen/one_piece.jpg", "https://www.justwatch.com/us/tv-show/one-piece"));
        shonen.add(new Recommendation("Dragon Ball Z", "images/anime/shonen/dbz.jpg", "https://myanimelist.net/anime/813/Dragon_Ball_Z"));
        shonen.add(new Recommendation("Bleach", "images/anime/shonen/bleach.jpg", "https://myanimelist.net/anime/269/Bleach"));
        shonen.add(new Recommendation("Jujutsu Kaisen", "images/anime/shonen/jujutsu_kaisen.jpg", "https://myanimelist.net/anime/40748/Jujutsu_Kaisen"));
        animeData.put("Shonen", shonen);

        // Seinen Anime
        List<Recommendation> seinen = new ArrayList<>();
        seinen.add(new Recommendation("Death Note", "images/anime/seinen/death_note.jpg", "https://myanimelist.net/anime/1535/Death_Note"));
        seinen.add(new Recommendation("Monster", "images/anime/seinen/monster.jpg", "https://myanimelist.net/anime/19/Monster"));
        seinen.add(new Recommendation("Psycho-Pass", "images/anime/seinen/psysho_pass.jpg", "https://myanimelist.net/anime/13601/Psycho-Pass"));
        seinen.add(new Recommendation("Tokyo Ghoul", "images/anime/seinen/tokyo_ghoul.jpg", "https://myanimelist.net/anime/22319/Tokyo_Ghoul"));
        seinen.add(new Recommendation("Berserk", "images/anime/seinen/berserk.jpg", "https://myanimelist.net/anime/33/Berserk"));
        seinen.add(new Recommendation("Cowboy Bebop", "images/anime/seinen/cowboy_bepop.jpg", "https://myanimelist.net/anime/1/Cowboy_Bebop"));
        seinen.add(new Recommendation("Ghost in the Shell", "images/anime/seinen/ghost_in_shell.jpg", "https://myanimelist.net/anime/43/Ghost_in_the_Shell__Stand_Alone_Complex"));
        seinen.add(new Recommendation("Parasyte", "images/anime/seinen/parasyte.jpg", "https://myanimelist.net/anime/22535/Kiseijuu__Sei_no_Kakuritsu"));
        animeData.put("Seinen", seinen);

        // Romance Anime
        List<Recommendation> animeRomance = new ArrayList<>();
        animeRomance.add(new Recommendation("Your Name", "images/anime/romance/your_name.jpg", "https://myanimelist.net/anime/32281/Kimi_no_Na_wa"));
        animeRomance.add(new Recommendation("A Silent Voice", "images/anime/romance/silent_voice.jpg", "https://myanimelist.net/anime/28851/Koe_no_Katachi"));
        animeRomance.add(new Recommendation("Weathering with You", "images/anime/romance/weathering_with_you.jpg", "https://myanimelist.net/anime/38826/Tenki_no_Ko"));
        animeRomance.add(new Recommendation("Your Lie in April", "images/anime/romance/your_lie_april.jpg", "https://myanimelist.net/anime/23273/Shigatsu_wa_Kimi_no_Uso"));
        animeRomance.add(new Recommendation("Toradora!", "images/anime/romance/toradora.jpg", "https://myanimelist.net/anime/4224/Toradora"));
        animeRomance.add(new Recommendation("Clannad", "images/anime/romance/clannad.jpg", "https://myanimelist.net/anime/2167/Clannad"));
        animeRomance.add(new Recommendation("Kaguya-sama: Love is War", "images/anime/romance/kaguya_sama.jpg", "https://myanimelist.net/anime/37999/Kaguya-sama_wa_Kokurasetai__Tensai-tachi_no_Renai_Zunousen"));
        animeRomance.add(new Recommendation("Horimiya", "images/anime/romance/horimiya.jpg", "https://myanimelist.net/anime/42897/Horimiya"));
        animeData.put("Romance", animeRomance);

        // Slice of Life Anime
        List<Recommendation> sliceOfLife = new ArrayList<>();
        sliceOfLife.add(new Recommendation("Spirited Away", "images/anime/sliceoflife/spirited_away.jpg", "https://myanimelist.net/anime/199/Sen_to_Chihiro_no_Kamikakushi"));
        sliceOfLife.add(new Recommendation("My Neighbor Totoro", "images/anime/sliceoflife/my_neighbor_totoro.jpg", "https://myanimelist.net/anime/523/Tonari_no_Totoro"));
        sliceOfLife.add(new Recommendation("Violet Evergarden", "images/anime/sliceoflife/violet_evergarden.jpg", "https://myanimelist.net/anime/33352/Violet_Evergarden"));
        sliceOfLife.add(new Recommendation("K-On!", "images/anime/sliceoflife/k_on.jpg", "https://myanimelist.net/anime/5680/K-On"));
        sliceOfLife.add(new Recommendation("Barakamon", "images/anime/sliceoflife/barakamon.jpg", "https://myanimelist.net/anime/22789/Barakamon"));
        sliceOfLife.add(new Recommendation("March Comes in Like a Lion", "images/anime/sliceoflife/march_comes_lion.jpg", "https://myanimelist.net/anime/31646/3-gatsu_no_Lion"));
        sliceOfLife.add(new Recommendation("Hyouka", "images/anime/sliceoflife/hyouka.jpg", "https://myanimelist.net/anime/12189/Hyouka"));
        sliceOfLife.add(new Recommendation("Classroom of the Elite", "images/anime/sliceoflife/cote.jpg", "https://www.imdb.com/title/tt7263328/"));
...
private VBox createFixedRecommendationCard(Recommendation rec, double cardWidth, double cardHeight) {
    ...
    card.setOnMouseClicked(e -> {
        if (rec.redirectUrl != null && !rec.redirectUrl.isEmpty()) {
            ...
            System.out.println("No URL available for " + rec.title);
        }
    });
    ...
    private void showFixedLoadingAnimation() {
        ...
        // Use available content area height
        double availableHeight = contentArea.getPrefHeight();
        loadingBox.setPrefHeight(availableHeight);
        loadingBox.setMaxHeight(availableHeight);
        
        // Responsive spacing based on available height
        double spacing = Math.max(15, availableHeight * 0.05);
        loadingBox.setSpacing(spacing);
        
        // Enhanced gradient background for loading with red theme
        LinearGradient loadingGradient = new LinearGradient(
            0, 0, 1, 1, true, CycleMethod.NO_CYCLE,
            new Stop(0, Color.rgb(229, 9, 20, 0.1)),
            new Stop(0.5, Color.rgb(180, 0, 0, 0.05)),
            new Stop(1, Color.rgb(229, 9, 20, 0.1))
        );
        BackgroundFill loadingFill = new BackgroundFill(loadingGradient, new CornerRadii(25), null);
        loadingBox.setBackground(new Background(loadingFill));
        
        // Enhanced spinner with fixed size
        ProgressIndicator spinner = new ProgressIndicator();
        double spinnerSize = Math.max(40, Math.min(80, availableHeight * 0.15));
        spinner.setPrefSize(spinnerSize, spinnerSize);
        spinner.setMaxSize(spinnerSize, spinnerSize);
        spinner.setMinSize(spinnerSize, spinnerSize);
        spinner.setStyle("-fx-accent: rgb(229, 9, 20);");
        
        // Add glow to spinner
        Glow spinnerGlow = new Glow();
        spinnerGlow.setLevel(0.5);
        spinner.setEffect(spinnerGlow);
        
        // Enhanced loading text with responsive font
        Label loadingText = new Label("🔥 Loading amazing content... 🔥");
        double loadingFontSize = Math.max(12, availableHeight * 0.04);
        loadingText.setFont(Font.font("Segoe UI", FontWeight.BOLD, loadingFontSize));
        loadingText.setTextFill(TEXT_COLOR);
        
        // Enhanced fade animation
        FadeTransition fadeTransition = new FadeTransition(Duration.seconds(1.5), loadingText);
        ...
        // Progress text with responsive font
        Label progressText = new Label("Please wait...");
        double progressFontSize = Math.max(8, availableHeight * 0.025);
        progressText.setFont(Font.font("Segoe UI", FontWeight.NORMAL, progressFontSize));
        progressText.setTextFill(Color.rgb(180, 180, 180));
        
        loadingBox.getChildren().addAll(spinner, loadingText, progressText);
    ...
    private Image loadLocalImage(String imagePath, double width, double height) {
        try {
            ...
            if (imageFile.exists()) {
                ...
                return new Image(fileUrl, width, height, true, true);
            } else {
                System.out.println("Image not found: " + imagePath);
                File placeholderFile = new File("images/placeholder.png");
                if (placeholderFile.exists()) {
                    String placeholderUrl = placeholderFile.toURI().toString();
                    return new Image(placeholderUrl, width, height, true, true);
                }
            }
        } catch (Exception e) {
    ...
    private void openURL(String url) {
        try {
            ...
            System.out.println("Error opening URL: " + url + " - " + e.getMessage());
        }
    }
